    ...
    <>
      <div className='flex gap-3'>
        <button
          ...
          className='flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors shadow-xs'
        >
          {loading ? (
            <>
              <svg
