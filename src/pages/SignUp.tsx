  ...
  const features = [
    {
      ...
      description: 'Automated accessibility testing for A, AA, and AAA levels',
    },
    {
      icon: TrendingUpIcon,
      title: 'Performance Insights',
      description: 'Real-time Core Web Vitals monitoring and optimization',
    },
    {
      icon: CheckCircleIcon,
      title: 'AI-Powered Fixes',
      description: 'Get code suggestions and automated pull requests',
    },
  ];
          ...
          <div className='space-y-8 max-w-md'>
            <div>
              ...
              <p className='text-lg text-muted-foreground text-balance'>
                Join thousands of developers using AI-powered tools to build
            ...
            <div className='border-l-2 border-primary pl-4'>
              <p className='text-foreground italic mb-2'>
                "FastFix helped us achieve 100% accessibility compliance and
                improved our Lighthouse scores by 35 points."
              </p>
